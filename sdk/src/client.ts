...
import { IERC165, IAuthProvider, IBurnableGovernanceStructure, IDiamondLoupe, IERC173, IERC20Metadata, IERC20Permit, IERC20, IERC6372, IGithubPullRequestFacet, IGovernanceStructure, IMembershipExtended, IMembership, IMintableGovernanceStructure, IPartialVotingFacet, IPartialVotingProposalFacet, IPlugin, IProposal, ITieredMembershipStructure, IVotes } from "../../typechain-types";
...
class DiamondGovernancePure {
  ...
  public async IAuthProvider(): Promise<IAuthProvider> {
    return await this._get<IAuthProvider>(
      DiamondGovernanceInterfaces.IAuthProvider,
      "0xb2aee3b9"
    );
  }

  public async IBurnableGovernanceStructure(): Promise<IBurnableGovernanceStructure> {
    return await this._get<IBurnableGovernanceStructure>(
      DiamondGovernanceInterfaces.IBurnableGovernanceStructure,
      "0x85d9cf86"
    );
  }

  public async IDiamondLoupe(): Promise<IDiamondLoupe> {
    return await this._get<IDiamondLoupe>(
      DiamondGovernanceInterfaces.IDiamondLoupe,
      "0x48e2b093"
    );
  }

  public async IERC173(): Promise<IERC173> {
    return await this._get<IERC173>(
      DiamondGovernanceInterfaces.IERC173,
      "0x7f5828d0"
    );
  }

  public async IERC20Metadata(): Promise<IERC20Metadata> {
    return await this._get<IERC20Metadata>(
      DiamondGovernanceInterfaces.IERC20Metadata,
      "0xa219a025"
    );
  }

  public async IERC20Permit(): Promise<IERC20Permit> {
    return await this._get<IERC20Permit>(
      DiamondGovernanceInterfaces.IERC20Permit,
      "0x9d8ff7da"
    );
  }
  ...
  public async IERC6372(): Promise<IERC6372> {
    return await this._get<IERC6372>(
      DiamondGovernanceInterfaces.IERC6372,
      "0xda287a1d"
    );
  }

  public async IGovernanceStructure(): Promise<IGovernanceStructure> {
    return await this._get<IGovernanceStructure>(
      DiamondGovernanceInterfaces.IGovernanceStructure,
      "0x217205e6"
    );
  }

  public async IMembershipExtended(): Promise<IMembershipExtended> {
    return await this._get<IMembershipExtended>(
      DiamondGovernanceInterfaces.IMembershipExtended,
      "0x2a21f601"
    );
  }

  public async IMembership(): Promise<IMembership> {
    return await this._get<IMembership>(
      DiamondGovernanceInterfaces.IMembership,
      "0xa230c524"
    );
  }

  public async IMintableGovernanceStructure(): Promise<IMintableGovernanceStructure> {
    return await this._get<IMintableGovernanceStructure>(
      DiamondGovernanceInterfaces.IMintableGovernanceStructure,
      "0x03520be9"
    );
  }

  public async IPartialVotingFacet(): Promise<IPartialVotingFacet> {
    return await this._get<IPartialVotingFacet>(
      DiamondGovernanceInterfaces.IPartialVotingFacet,
      "0xe7ce0a62"
    );
  }

  public async IPartialVotingProposalFacet(): Promise<IPartialVotingProposalFacet> {
    return await this._get<IPartialVotingProposalFacet>(
      DiamondGovernanceInterfaces.IPartialVotingProposalFacet,
      "0x823113d4"
    );
  }

  public async IPlugin(): Promise<IPlugin> {
    return await this._get<IPlugin>(
      DiamondGovernanceInterfaces.IPlugin,
      "0x41de6830"
    );
  }

  public async IProposal(): Promise<IProposal> {
    return await this._get<IProposal>(
      DiamondGovernanceInterfaces.IProposal,
      "0xda35c664"
    );
  }

  public async ITieredMembershipStructure(): Promise<ITieredMembershipStructure> {
    return await this._get<ITieredMembershipStructure>(
      DiamondGovernanceInterfaces.ITieredMembershipStructure,
      "0xdea631ee"
    );
  }

  public async IVotes(): Promise<IVotes> {
    return await this._get<IVotes>(
      DiamondGovernanceInterfaces.IVotes,
      "0xe90fb3f6"
    );
  }

  public async IVerificationFacet(): Promise<IVerificationFacet> {
    return await this._get<IVerificationFacet>(
      DiamondGovernanceInterfaces.IVerificationFacet,
      "0x40cd79b9"
    );
  }

  private async _get<Type>(
    _interface: DiamondGovernanceInterfaces,
    _interfaceId: string
  ): Promise<Type> {
