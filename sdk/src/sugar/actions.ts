 ...
 */
export async function ToAction(contracts : any, toAddress : string, action : Action) : Promise<IDAO.ActionStruct> {
 ...
 */
export async function ParseAction(contracts : any, action : IDAO.ActionStruct) : Promise<Action> {
    if (action.value == 0) {
      return {
