...
/// @notice The interface of partial voting plugin.
...
interface IPartialVoting {
    ...
    function vote(uint256 _proposalId, PartialVote calldata _voteData, bool _tryEarlyExecution) external;
    ...
    function getVoteOption(
        uint256 _proposalId,
        address _account
    ) external view returns (PartialVote[] calldata);
}
