...
contract DiamondInit {
    ...
    function init(
        ...
        ERC20OneTimeVerificationRewardFacetInit.InitParams
            memory _onetimeClaimSettings,
        SearchSECOMonetizationFacetInit.InitParams
            memory _searchSECOMonetizationSettings,
        SearchSECORewardingFacetInit.InitParams
            memory _searchSECORewardingSettings
    ) external {
        // adding ERC165 data
