...
export async function setDeployedDiamondGovernance(_deployedDiamondGovernanceJson : { [contractName: string]: { address: string } }, signer : Signer) {
...
export async function getDeployedENSFramework(signer : Signer) : Promise<ENSFrameworkContracts> {
 ...
 export async function getDeployedDiamondGovernance(signer : Signer) : Promise<any> {
    ...
    const deployedContracts : { [networkName : string]: any } = deployed_DiamondGovernanceJson;
    if (!deployedContracts.hasOwnProperty(network)) {
...
export async function getDiamondGovernanceRepo(signer : Signer)  : Promise<string> {
    ...
    const deployedContracts : { [networkName : string]: any } = DiamondGovernanceRepoJson;
    if (!deployedContracts.hasOwnProperty(network)) {
...
async function diamondGovernanceJsonToContracts(diamondGovernanceJson : { [contractName: string]: { address: string } }, signer : Signer) : Promise<{ [contractName : string]: NamedContract }> {
